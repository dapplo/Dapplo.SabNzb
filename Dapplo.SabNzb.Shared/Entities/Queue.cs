...
namespace SabnzbdClient.Client.Entities
{
	...
	public class Queue
	{
		...
		[DataMember(Name = "isverbose", EmitDefaultValue = false)]
		...
		[DataMember(Name = "queue_details", EmitDefaultValue = false)]
		public string QueueDetails { get; set; }

		[DataMember(Name = "refresh_rate", EmitDefaultValue = false)]
